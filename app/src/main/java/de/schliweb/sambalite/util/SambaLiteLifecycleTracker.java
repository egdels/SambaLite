...
/**
 * Activity Lifecycle Tracker for the app Monitors app foreground/background transitions to improve
 * SMB connection resilience
 */
public class SambaLiteLifecycleTracker implements Application.ActivityLifecycleCallbacks {
  ...
  @Getter private boolean isAppInForeground = true;
  @Setter private LifecycleListener lifecycleListener;

  // Background operation cancellation callback
  @Setter private BackgroundOperationCanceller backgroundOperationCanceller;
