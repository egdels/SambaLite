...
/**
 * Represents a cache entry with data and metadata. This class encapsulates the cached data along
 * with information about its expiration and version.
 *
...
public class CacheEntry<T> implements Serializable {
  ...
  @Getter private final long expirationTime;

  @Getter private final int cacheVersion;

  @Getter private final long creationTime;

  @Getter private long lastAccessTime;
