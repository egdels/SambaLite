 ...
 * class can be used to test the cache hit rate calculation and ensure that cache hits are being
 * properly counted.
 */
public class CachePerformanceTest {
  ...
  public static void testCacheHitRate(@NonNull Context context) {
    ...
    HybridCacheStrategy<String, Serializable> hybridStrategy =
        new HybridCacheStrategy<>(memoryStrategy, diskStrategy, statistics);
