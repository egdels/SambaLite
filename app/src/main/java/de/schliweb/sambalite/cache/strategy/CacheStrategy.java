...
/**
 * Interface defining a caching strategy. Different implementations can provide different caching
 * behaviors (memory-only, disk-only, hybrid).
 *
...
public interface CacheStrategy<K, V> {
  ...
  /**
   * Performs maintenance operations on the cache. This might include removing expired entries,
