...
public class ConnectionAdapter
  ...
  public ConnectionViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    View view =
        LayoutInflater.from(parent.getContext()).inflate(R.layout.item_connection, parent, false);
  ...
  public void onBindViewHolder(@NonNull ConnectionViewHolder holder, int position) {
    ...
    LogUtils.d(
        "ConnectionAdapter",
        "Binding connection at position " + position + ": " + connection.getName());
      ...
      itemView.setOnClickListener(
          v -> {
            ...
            if (position != RecyclerView.NO_POSITION && listener != null) {
              SmbConnection connection = connections.get(position);
              LogUtils.d(
                  "ConnectionAdapter", "Notifying listener of click on: " + connection.getName());
      ...
      moreOptionsButton.setOnClickListener(
          v -> {
            ...
            if (position != RecyclerView.NO_POSITION && listener != null) {
              ...
              LogUtils.d(
                  "ConnectionAdapter",
                  "Notifying listener of options click on: " + connection.getName());
