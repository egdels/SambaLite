...
/**
 * Persistent action log for folder sync operations.
 * Stores the most recent sync actions in SharedPreferences (FIFO, max 100 entries).
 */
public class SyncActionLog {
    ...
    public String getFormattedLog(int maxEntries) {
        ...
        sb.append("Showing ").append(recent.size()).append(" of ").append(total).append(" entries (newest first)\n\n");
        ...
        sb.append("\nTotal: ").append(uploaded).append(" uploaded, ")
                .append(downloaded).append(" downloaded, ")
                .append(skipped).append(" skipped, ")
                .append(dirs).append(" dirs created, ")
