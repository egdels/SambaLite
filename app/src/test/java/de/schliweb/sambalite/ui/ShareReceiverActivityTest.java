...
/**
 * Unit tests for ShareReceiverActivity helper methods.
 * Uses reflection to test private methods since the Activity has heavy DI dependencies.
 */
...
public class ShareReceiverActivityTest {
    ...
    public void getConnectionNameFromTargetFolder_withSlash_returnsPrefix() throws Exception {
        Method method = ShareReceiverActivity.class.getDeclaredMethod("getConnectionNameFromTargetFolder", String.class);
    ...
    public void getPathFromTargetFolder_withSlash_returnsPathAfterSlash() throws Exception {
        Method method = ShareReceiverActivity.class.getDeclaredMethod("getPathFromTargetFolder", String.class);
        method.setAccessible(true);
    ...
    public void createTempTextFile_withTextAndSubject_createsFile() throws Exception {
        ...
        ShareReceiverActivity act = Robolectric.buildActivity(ShareReceiverActivity.class,
                new Intent(Intent.ACTION_SEND).setType("text/plain")).get();

        Method method = ShareReceiverActivity.class.getDeclaredMethod("createTempTextFile", String.class, String.class);
        method.setAccessible(true);
        ...
        assertTrue("Filename should contain sanitized subject", result.getPath().contains("My_Subject"));
    ...
    public void createTempTextFile_filenameContainsTimestamp() throws Exception {
        ...
        assertTrue("Filename should match timestamp pattern",
                fileName.matches("test_\\d{8}_\\d{6}\\.txt"));
    }
}
