...
/**
 * Tests for the local folder collision detection logic in FileBrowserActivity.
 * Verifies that sync configurations cannot overlap (exact match, parent, or child).
 */
public class LocalFolderCollisionTest {

    private static final String BASE_URI = "content://com.android.externalstorage.documents/tree/primary%3A";
    ...
    public void noCollision_emptyList() {
        assertNull(FileBrowserActivity.checkLocalFolderCollision(
    ...
    public void exactMatch_detected() {
        ...
        assertEquals(FileBrowserActivity.LocalFolderCollisionType.EXACT_MATCH,
    ...
    public void parentSynced_detected() {
        ...
        assertEquals(FileBrowserActivity.LocalFolderCollisionType.PARENT_SYNCED,
                FileBrowserActivity.checkLocalFolderCollision(
                        BASE_URI + "Photos/Vacation", configs, null));
    }
    ...
    public void childSynced_detected() {
        ...
        assertEquals(FileBrowserActivity.LocalFolderCollisionType.CHILD_SYNCED,
                FileBrowserActivity.checkLocalFolderCollision(
                        BASE_URI + "Photos", configs, null));
    }
    ...
    public void editingConfig_excluded() {
        ...
        assertNull(FileBrowserActivity.checkLocalFolderCollision(
                BASE_URI + "Photos", configs, "edit-1"));
    }
    ...
    private static final String ENCODED_URI = "content://com.android.externalstorage.documents/tree/primary%3A";
    ...
    public void encodedUri_childSynced_detected() {
        ...
        assertEquals(FileBrowserActivity.LocalFolderCollisionType.CHILD_SYNCED,
                FileBrowserActivity.checkLocalFolderCollision(
                        ENCODED_URI + "FolderA", configs, null));
    }
    ...
    public void encodedUri_deeplyNested_parentDetected() {
        ...
        assertEquals(FileBrowserActivity.LocalFolderCollisionType.PARENT_SYNCED,
                FileBrowserActivity.checkLocalFolderCollision(
                        ENCODED_URI + "A%2FB%2FC", configs, null));
    }
}
