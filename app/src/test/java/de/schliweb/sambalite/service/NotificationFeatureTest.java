 ...
 * - Idle vs. active operations
 * - Operation types: Search, Upload, Download, Delete/Rename (generic cancelable)
 * - Notification actions: Stop (idle), Cancel (active cancelable), none (active non-cancelable)
 * - Notification content: title, text
 * - Content intent: Search/Upload/Download deep links vs. generic fallback
 * - Multiple operations and transitions between states
 * - ACTION_STOP removes notification
 * - ACTION_CANCEL updates notification
 */
...
public class NotificationFeatureTest {
    ...
    public void idle_notificationIsSilent() {
        ...
        assertTrue("Notification channel should be low importance (silent)",
    ...
    public void afterFinishOperation_serviceBecomesIdle() {
        ...
        assertFalse("Service should be idle after finishing all operations", service.hasActiveOperations());
    }
    ...
    public void setSearchParameters_updatesNotification() {
        ...
        String title = n.extras.getString(Notification.EXTRA_TITLE);
        assertNotNull(title);
        assertTrue("After setSearchParameters, title should contain 'Searching'", title.contains("Searching"));
    }
    ...
    public void setUploadParameters_updatesNotification() {
        ...
        String title = n.extras.getString(Notification.EXTRA_TITLE);
        assertNotNull(title);
        assertTrue("After setUploadParameters, title should contain 'Uploading'", title.contains("Uploading"));
    }
    ...
    public void setDownloadParameters_updatesNotification() {
        ...
        String title = n.extras.getString(Notification.EXTRA_TITLE);
        assertNotNull(title);
        assertTrue("After setDownloadParameters, title should contain 'Downloading'", title.contains("Downloading"));
    }
    ...
    public void actionStop_whileActive_removesNotification() {
        ...
        List<Notification> remaining = shadowNotificationManager.getAllNotifications();
        assertTrue("Notification should be removed after ACTION_STOP even with active ops", remaining.isEmpty());
    }
    ...
    public void actionCancel_notificationShowsCancelledText() {
        ...
        String title = n.extras.getString(Notification.EXTRA_TITLE);
        assertNotNull(title);
        assertTrue("After cancel, title should indicate cancellation",
    ...
    public void multipleOps_searchThenDelete_searchFlagsOverrideCancel() {
        ...
        Notification.Action cancelAction = findAction(n, "Cancel");
        assertNotNull("After search→delete, Cancel should appear (delete is cancelable, search flag cleared)", cancelAction);
    }
    ...
    public void notificationChannel_isCreated() {
        ...
        NotificationManager nm = (NotificationManager)
                service.getSystemService(Context.NOTIFICATION_SERVICE);
        assertNotNull("Notification channel should exist",
    ...
    public void repeatedStartCommands_sameNotificationId() {
        ...
        assertEquals("Repeated starts should not create additional notifications",
    ...
    public void idle_noContentIntent() {
        startServiceNormally();
        Notification n = getPostedNotification();
        assertNull("Idle notification ('SMB Service ready') should have no content intent",
                n.contentIntent);
    }
    ...
    public void activeOp_hasContentIntent() {
        ...
        service.startOperation("delete");
        Notification n = getPostedNotification();
        assertNotNull("Active operation notification should have a content intent",
                n.contentIntent);
    }
    ...
    public void searchOp_withParams_hasContentIntent() {
        ...
        service.startOperation("search");
        Notification n = getPostedNotification();
        assertNotNull("Search operation with params should have a content intent",
                n.contentIntent);
    }
    ...
    public void uploadOp_withParams_hasContentIntent() {
        ...
        service.startOperation("upload");
        Notification n = getPostedNotification();
        assertNotNull("Upload operation with params should have a content intent",
                n.contentIntent);
    }
    ...
    public void downloadOp_withParams_hasContentIntent() {
        ...
        service.startOperation("download");
        Notification n = getPostedNotification();
        assertNotNull("Download operation with params should have a content intent",
                n.contentIntent);
    }
}
