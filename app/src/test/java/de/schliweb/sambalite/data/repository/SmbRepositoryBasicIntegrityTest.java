...
public class SmbRepositoryBasicIntegrityTest {
    ...
    public void testFileIntegrityUtilities() throws Exception {
        ...
        assertTrue("Files should be byte-for-byte identical", 
                  compareFilesByteByByte(testFile, copiedFile));
    }
    ...
    public void testSmbFileItemIntegrity() {
        ...
        SmbFileItem fileItem = new SmbFileItem("test.txt", "/test.txt", 
                                             SmbFileItem.Type.FILE, 1024, new Date());
        ...
        // Test directory item
        SmbFileItem dirItem = new SmbFileItem("testdir", "/testdir", 
                                            SmbFileItem.Type.DIRECTORY, 0, new Date());
    ...
    public void testRepositoryAPIExists() {
        ...
        try {
            ...
            assertTrue("Should fail gracefully", expected.getMessage() != null);
        }
    }
    ...
    public void testLargeFileSimulation() throws Exception {
        ...
        assertEquals("Large file hash should match - NO DATA CORRUPTION!", 
                    originalHash, transferredHash);
    }
    ...
    public void testSequentialFileOperations() throws Exception {
        ...
        for (int i = 0; i < testFiles.size(); i++) {
            ...
            assertEquals("Sequential file " + i + " should maintain integrity", 
    ...
    public void testRepeatingPatterns() throws Exception {
        ...
        for (Map.Entry<String, byte[]> test : patternTests.entrySet()) {
            ...
            assertEquals("Pattern " + patternName + " size should match", 
                        pattern.length, (int)copiedPatternFile.length());
