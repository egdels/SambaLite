...
/**
 * Tests for the getMimeType method in FolderSyncWorker.
 * Verifies that common file extensions are mapped to the correct MIME types
 * and that unknown extensions fall back to application/octet-stream.
 */
...
public class FolderSyncWorkerGetMimeTypeTest {
    ...
    public void setUp() {
        ...
        worker = TestWorkerBuilder.from(context, FolderSyncWorker.class, Executors.newSingleThreadExecutor()).build();
    }
