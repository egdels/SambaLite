...
/**
 * An in-memory implementation of a Samba server for testing. This server runs within the JUnit test
...
public class SambaContainer {
  ...
  /**
   * Executes a command in the container. This is a simplified version that only supports creating
   * files.
   *
